...
In root folder of Couponshelf template run:
```
npm i
```
...
What is important:
* The main file for compilation is `iabootstrap.less`. It should be compiled to `[root]/templates/couponshelf/css/iabootstrap.css`
